...
if(! defined('FILE_CACHE_PREFIX') )             define ('FILE_CACHE_PREFIX', 'aoton');
...
if(! defined('DEFAULT_WIDTH') )                         define ('DEFAULT_WIDTH', 700);
if(! defined('DEFAULT_HEIGHT') )                        define ('DEFAULT_HEIGHT', 300);
