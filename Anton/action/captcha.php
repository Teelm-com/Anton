...
if($_POST['action'] == 'aoton_captcha' && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
...
function sessioncode($email){
	...
	$_SESSION['aoton_safe_captcha']=strtolower($_dscode);
	$_SESSION['aoton_safe_captcha_email']=$email; 
	$message .= '验证码：'.$_dscode;  
